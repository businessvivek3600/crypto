      ...
      child: Timeline.tileBuilder(
        theme: TimelineThemeData(
          ...
          connectorTheme: const ConnectorThemeData(
              thickness: 3.0, color: Color(0xffd3d3d3)),
            ...
            switch (data[index]) {
              ...
              case _TimelineStatus.sync:
                return const DotIndicator(
                    ...
                    child: Icon(Icons.sync, size: 10.0, color: Colors.white));
    ...
    return Flexible(
      child: Timeline.tileBuilder(
        theme: TimelineThemeData(
          ...
          connectorTheme: const ConnectorThemeData(
              color: Color(0xffe6e7e9), thickness: 15.0),
        ),
        padding: const EdgeInsets.only(top: 20.0),
        builder: TimelineTileBuilder.connected(
          indicatorBuilder: (context, index) {
            ...
            return OutlinedDotIndicator(
              ...
              borderWidth: status.isInProgress ? 4.0 : 2.5,
            );
          },
          ...
          contentsBuilder: (context, index) {
            ...
            return SizedBox(
              height: height,
              child: Align(
                  alignment: Alignment.centerLeft, child: _EmptyContents()),
            );
          },
          itemCount: data.length,
        ),
...
enum _TimelineStatus { done, sync, inProgress, todo }
