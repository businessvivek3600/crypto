...
import '../../../widgets/time_line/timelines.dart';
import '../widget.dart';
    ...
    return Row(
      children: [
        ...
        Text(
          ...
          style: const TextStyle(color: Color(0xffb6b2b2)),
        ),
      ],
    );
  }
    ...
    return Padding(
      ...
      child: FixedTimeline.tileBuilder(
        theme: TimelineTheme.of(context).copyWith(
          nodePosition: 0,
          connectorTheme:
              TimelineTheme.of(context).connectorTheme.copyWith(thickness: 1.0),
          indicatorTheme: TimelineTheme.of(context)
              .indicatorTheme
              .copyWith(size: 10.0, position: 0),
        ),
          ...
          builder: TimelineTileBuilder.connected(
            ...
            contentsBuilder: (_, index) {
              if (processes[index].isCompleted) {
                return Padding(
                  ...
                  child: Text(processes[index].name,
            ...
            indicatorBuilder: (_, index) {
              if (processes[index].isCompleted) {
                ...
                return const DotIndicator(color: Color(0xff6676c9));
              }
            },
      ...
      deliveryProcesses: [
        ...
        const _DeliveryProcess(
          ...
          messages: [
            ...
            _DeliveryMessage('11:35am',
                'Package delivered by m.vass il iad esPackage deliveredred by m.vass il iad esPackage delivered by m.vas silia des'),
          ],
        ),
